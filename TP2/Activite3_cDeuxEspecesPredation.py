...
plt.xlabel('N')
plt.ylabel('P')
plt.plot(Na_values_1, Pa_values_1, color = 'red', label='Trajectoria 1')
plt.plot(Na_values_2, Pa_values_2, color = 'dodgerblue', label='Trajectoria 2')
plt.plot(Na_values_3, Pa_values_3, color = 'deeppink', label='Trajectoria 3')
...
plt.ylabel('P')
plt.title('Isoclines of Lotka-Volterra Extended')
plt.plot(Nc_values_1, Pc_values_1, color = 'red', label='Trajectoria 1')
plt.plot(Nc_values_2, Pc_values_2, color = 'dodgerblue', label='Trajectoria 2')
plt.plot(Nc_values_3, Pc_values_3, color = 'deeppink', label='Trajectoria 3')
plt.streamplot(vN, vP, dN, dP, color = 'gray', density=1, arrowstyle='->', linewidth=0.7)
plt.xlim(0, 2)
plt.ylim(0, 10)
plt.legend()
