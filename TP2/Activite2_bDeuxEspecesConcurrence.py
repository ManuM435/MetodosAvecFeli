...
plt.plot(turtles1, color='lightblue', label='Turtles (a1 > a2)')
plt.plot(pandas2, color = 'red', label='Pandas (N0P > N0T)')
plt.plot(turtles2, color = 'orange', label='Turtles (N0P > N0T)')
plt.xlabel('Time')
...
# TODO Convertirlos en una figura con 2 subplots
plt.plot(pandas3, color = 'blue', label='Pandas (r1 > r2)')
plt.plot(turtles3, color = 'lightblue', label='Turtles (r1 > r2)')
plt.plot(pandas4, color = 'red', label='Pandas (K1 > K2)')
plt.plot(turtles4, color = 'orange', label='Turtles (K1 > K2)')
plt.xlabel('Time')
plt.ylabel('Population')
plt.title('Population dynamics of two species')
plt.legend()
