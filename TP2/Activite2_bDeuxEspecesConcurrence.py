...
# plt.plot(N1a, isoclineN2a, label='Isocline of N2', color = 'limegreen')
# plt.xlabel('N1')
# plt.ylabel('N2')
# plt.legend()
# plt.streamplot(vn1, vn2, dN1, dN2, color = 'gray', density=1.5, arrowstyle='->', linewidth=1)
# plt.xlim(0,80)
# plt.ylim(0,80)
# plt.show()
...
# # plt.plot(N1b, isoclineN2b, label='Isocline of N2', color = 'limegreen')
# # plt.xlabel('N1')
# # plt.ylabel('N2')
# # plt.legend()
# # plt.streamplot(vn1, vn2, dN1, dN2, color = 'gray', density=1.5, arrowstyle='->', linewidth=1)
...
# # Vectores
# vn1 = np.linspace(0, 120, 40)
# vn2 = np.linspace(0, 120, 40)
# VN1, VN2 = np.meshgrid(vn1, vn2)
